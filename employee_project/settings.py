...
SECRET_KEY = 'django-insecure-l297unnc_!+9fc6k&@pn!*rp)_ywznbo7tr3)mygagp33*xyb+'
...
STATICFILES_DIRS = [BASE_DIR / "static"]  # If your static files are in a "static" folder in project root
